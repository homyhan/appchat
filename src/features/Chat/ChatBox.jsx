    ...
    return (
        <section style={{padding: "0px"}} className="chat">
            <div className="header-chat">
                ...
                {toUser?.isRoom === 1 ? (<div style={{display:'flex', alignItems:'center'}}>
                        <p className="quantity_mem me-3">Member
                        orther: {listMesRoom?.userList?.length}</p>
                        <button
                            style={{margin:'0px', display:'inline-block', width:'50px !important'}}
                            type="button"
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            {listMesRoom?.userList?.map((item, index)=>{
                                return <p key={item.id} style={{paddingBottom:'8px', borderBottom:'1px solid #e0e0e0'}}>{item.name}</p>
                            })}
                        </div>
                    </div>
                </div>
